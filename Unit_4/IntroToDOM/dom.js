...
h1.style = `text-shadow: 2px 2px 2px green;
color: purple;
text-align: center;`;
...
let btn = document.getElementById("submit"); // "Grabs"/creates reference to the button with an id of "submit"
...
function addItem() {
    ...
    // Targeting the input node via the variable name and whatever information is being stored in value property
    console.log(input.value);
        ...
        newItem.class = "listItem";
        newItem.textContent = input.value;

        // Append new element to parent element
        ul.appendChild(newItem);

        // Kate being extra and wanting to set the input to blank ""
        input.value = "";
}

// Creating something NEW!

// Global Variables: build button, parent contain, mock/"faux" data
