...
/* 
    ...
    4.) The parameters for our constructed object. Establishes the values of our new object.
    5.) This keyword - refers to "this" specific object being created.
    6.) The name of a key to our new object. (In this ex, an Item object will have three keys: name, description, and price.)
...
// Instantiate/Create an object off of class Item w/ and w/o value:
...
class Expense {
    // static keyword, creates/build a new expense
