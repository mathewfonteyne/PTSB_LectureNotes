...
// Import needed elements from reactstrap
...
export default function MovieCreate(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    // Construct body object & JSON stringify it
    ...
    try {
      ...
      // console.log(data);
      // Call the fetchMovieS function via props to refresh our table after movie is added
      props.fetchMovies();
    } catch (err) {
      console.error(err);
    }
