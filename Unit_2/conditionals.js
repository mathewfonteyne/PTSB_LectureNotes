...
if(loggedInUser == true) {
    ...
    console.log("Please log in or sign up to use the site!");
}
...
console.log("My name is ${myName} and my best friendo is ${bff}!") // Just a normal string
...
switch(true) {
    ...
    case grade == "F":
        ...
        break;
    default:
        console.log("That is not a grade value...");
}